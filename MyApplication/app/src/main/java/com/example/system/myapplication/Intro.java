...
public class Intro extends AppIntro {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        addSlide(SampleSlide.newInstance(R.layout.slide9));
        addSlide(SampleSlide.newInstance(R.layout.slide6));
        addSlide(SampleSlide.newInstance(R.layout.slide10));
        addSlide(SampleSlide.newInstance(R.layout.slide11));
        addSlide(SampleSlide.newInstance(R.layout.slide12));
